...
var InPageContentEdit=function(a){this.m_parent=a;this.m_action=a.dataset.action;this.m_pageId=a.dataset.pageId;this.m_text=JSON.parse(a.dataset.text);this.m_contentId=a.dataset.contentId;this.m_rawContent=a.dataset.rawContent;this.m_editableArea=a.querySelector(".in-page-content-edit__editable-area");this.m_editableAreaDisplay=window.getComputedStyle(this.m_editableArea,null).getPropertyValue("display");this.m_editor=a.querySelector(".in-page-content-edit__editor");this.m_editor.value=this.m_rawContent;
this.m_editor.style.display="none";this.m_editor.style.resize="none";this.m_editor.style.overflow="hidden";this.m_editor.style.width="100%";this.m_editor.style.minHeight=this.getEditableAreaProperty("line-height");this.m_editor.style.fontSize=this.getEditableAreaProperty("font-size");this.m_editor.style.fontFamily=this.getEditableAreaProperty("font-family");this.m_editor.style.fontWeight=this.getEditableAreaProperty("font-weight");this.m_editor.style.lineHeight=this.getEditableAreaProperty("line-height");
this.m_editor.style.color=this.getEditableAreaProperty("color");this.m_editor.style.textDecoration=this.getEditableAreaProperty("text-decoration");this.m_editor.style.padding=this.getEditableAreaProperty("padding");this.m_editor.style.margin=this.getEditableAreaProperty("margin");this.m_editor.style.marginBottom="0";this.m_editor.style.border=this.getEditableAreaProperty("border");this.m_editor.style.boxShadow=this.getEditableAreaProperty("box-shadow");this.m_editor.style.borderRadius=this.getEditableAreaProperty("border-radius");
this.m_buttons=a.querySelector(".in-page-content-edit__buttons");this.m_buttons.style.display="none";this.m_buttons.querySelectorAll(".toolbar > *").forEach(function(a){a.style.marginTop="var(--gutter-thin)"});this.m_buttonSave=this.m_buttons.querySelector('[data-action="save"]');this.m_buttonPreview=this.m_buttons.querySelector('[data-action="preview"]');this.m_buttonCancel=this.m_buttons.querySelector('[data-action="cancel"]');this.m_modified=!1;this.addListeners();this.checkIfEmpty()};
InPageContentEdit.prototype.getEditableAreaProperty=function(a){return window.getComputedStyle(this.m_editableArea,null).getPropertyValue(a)};
