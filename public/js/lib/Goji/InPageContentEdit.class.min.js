...
InPageContentEdit.prototype.lockEditor=function(a){this.m_editor.disabled=a;this.m_buttonSave.disabled=a;this.m_buttonPreview.disabled=a;this.m_buttonCancel.disabled=a};InPageContentEdit.prototype.xhrSuccess=function(a,b,c,d){c=void 0===c?null:c;d=void 0===d?null:d;try{if(200!==b)throw 0;this.m_editableArea.innerHTML=a.content;null!==c&&c();this.deactivateEditMode();this.lockEditor(!1)}catch(e){this.xhrError(d)}this.checkIfEmpty()};
InPageContentEdit.prototype.xhrError=function(a){a=void 0===a?null:a;null!==a&&a();this.lockEditor(!1)};InPageContentEdit.prototype.xhrPost=function(a,b,c){var d=this;b=void 0===b?null:b;c=void 0===c?null:c;var e=new FormData;e.append("content-id",this.m_contentId);e.append("page-id",this.m_pageId);e.append("action",a);e.append("content",this.m_editor.value);SimpleRequest.post(this.m_action,e,function(a,e){d.xhrSuccess(a,e,b,c)},function(){d.xhrError(c)},function(){d.xhrError(c)},null,{get_json:!0})};
