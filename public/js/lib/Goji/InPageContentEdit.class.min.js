...
this.m_editor.style.boxShadow=this.m_editableAreaStyle.getPropertyValue("box-shadow");this.m_editor.style.borderRadius=this.m_editableAreaStyle.getPropertyValue("border-radius");this.m_editor.classList.remove("hidden");this.m_buttons=a.querySelector(".in-page-content-edit__buttons");this.m_buttons.style.display="none";this.m_buttons.classList.remove("hidden");this.m_buttons.querySelectorAll(".toolbar > *").forEach(function(b){b.style.marginTop="var(--gutter-thin)"});this.m_buttonSave=this.m_buttons.querySelector('[data-action="save"]');
this.m_buttonPreview=this.m_buttons.querySelector('[data-action="preview"]');this.m_buttonCancel=this.m_buttons.querySelector('[data-action="cancel"]');this.m_modified=!1;this.addListeners();this.checkIfEmpty()};
...
function(){a.resizeEditorDelayed()},!1);this.m_buttonSave.addEventListener("click",function(d){a.saveEdition(d)},!1);this.m_buttonPreview.addEventListener("click",function(){a.previewEdition()},!1);this.m_buttonCancel.addEventListener("click",function(d){a.cancelEdition(d)},!1)}};
InPageContentEdit.prototype.resizeEditor=function(){var a=this,b=window.scrollX,c=window.scrollY;requestAnimationFrame(function(){a.m_editor.style.height="auto";a.m_editor.style.height=a.m_editor.scrollHeight+"px";window.scrollTo(b,c)})};InPageContentEdit.prototype.resizeEditorDelayed=function(){var a=this;setTimeout(function(){a.resizeEditor()},7)};InPageContentEdit.prototype.setModified=function(a){(this.m_modified=a)?this.m_parent.classList.add("modified"):this.m_parent.classList.remove("modified")};
InPageContentEdit.prototype.checkIfEmpty=function(){this.m_editor.value.match(/^\s*$/)&&(this.m_editableArea.textContent=this.m_text.placeholder)};InPageContentEdit.prototype.activateEditMode=function(){this.m_editableArea.style.display="none";this.m_editor.style.display=this.m_editableAreaDisplay;this.m_editor.focus();this.m_editor.setSelectionRange(this.m_editor.value.length,this.m_editor.value.length);this.m_buttons.style.display="block";this.resizeEditorDelayed()};
InPageContentEdit.prototype.deactivateEditMode=function(){this.m_editableArea.style.display=null;this.m_editor.style.display="none";this.m_buttons.style.display="none"};InPageContentEdit.prototype.lockEditor=function(a){this.m_editor.disabled=a;this.m_buttonSave.disabled=a;this.m_buttonPreview.disabled=a;this.m_buttonCancel.disabled=a};
InPageContentEdit.prototype.xhrSuccess=function(a,b,c,d){c=void 0===c?null:c;d=void 0===d?null:d;try{if(200!==b)throw 0;this.m_editableArea.innerHTML=a.content;null!==c&&c();this.deactivateEditMode();this.lockEditor(!1)}catch(e){this.xhrError(d)}this.checkIfEmpty()};InPageContentEdit.prototype.xhrError=function(a){a=void 0===a?null:a;null!==a&&a();this.lockEditor(!1)};
InPageContentEdit.prototype.xhrPost=function(a,b,c){var d=this;b=void 0===b?null:b;c=void 0===c?null:c;var e=new FormData;e.append("content-id",this.m_contentId);e.append("page-id",this.m_pageId);e.append("action",a);e.append("content",this.m_editor.value);SimpleRequest.post(this.m_action,e,function(f,g){d.xhrSuccess(f,g,b,c)},function(){d.xhrError(c)},function(){d.xhrError(c)},null,{get_json:!0})};
