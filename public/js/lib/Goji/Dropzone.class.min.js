...
Dropzone.prototype.fileIsValid=function(a){if(""===a.type)return null!==this.m_callbackErrorFileTypeInvalid&&this.m_callbackErrorFileTypeInvalid("_folder_"),!1;if(0<this.m_fileTypesAllowed.length){var c=this.extractFileType(a).toLowerCase();if(!this.m_fileTypesAllowed.includes(c))return null!==this.m_callbackErrorFileTypeInvalid&&this.m_callbackErrorFileTypeInvalid(c),!1}return 0<this.m_maxFileSize&&a.size>this.m_maxFileSize?(null!==this.m_callbackErrorFileTooHeavy&&this.m_callbackErrorFileTooHeavy(a.size),
!1):!0};Dropzone.prototype.drop=function(a){var c=[];if(a.dataTransfer.items){a=$jscomp.makeIterator(a.dataTransfer.items);for(var b=a.next();!b.done;b=a.next())if(b=b.value,"file"===b.kind&&(b=b.getAsFile(),this.fileIsValid(b))){var d=new Map;d.set("file",b);c.push(d)}}else for(a=$jscomp.makeIterator(a.dataTransfer.files),b=a.next();!b.done;b=a.next())b=b.value,this.fileIsValid(b)&&(d=new Map,d.set("file",b),c.push(d));this.newFiles(c)};
