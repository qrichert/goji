var Form=function(a,b,c,e,d){var f=this;b=void 0===b?null:b;c=void 0===c?null:c;e=void 0===e?null:e;d=void 0===d?null:d;this.m_parent=a;this.m_parent.addEventListener("submit",function(a){f.submit(a)},!1);this.m_callbackSuccess=b;this.m_callbackError=c;this.m_statusBearer=e;this.m_progressBar=d;this.m_progressBarProgress=d.querySelector(".progress");this.m_currentXHR=null;this.m_loadingInProgress=!1;this.m_loadingStatus={NONE:0,LOADING:1,LOADED:2,FAILED:3}};
...
Form.prototype.submit=function(a){var b=this;a=void 0===a?null:a;null!==a&&a.preventDefault();if(!this.m_loadingInProgress){this.setLoadingStatus(this.m_loadingStatus.LOADING);null!==this.m_progressBar&&this.m_progressBar.classList.add("shown");a=this.m_parent.action;var c=new FormData(this.m_parent);c.append("ajax-http-request","true");this.m_currentXHR=SimpleRequest.post(a,c,function(a){b.load(a)},function(a){b.error()},function(a){b.abort()},function(a,c){b.progress(a,c)},{encode_uri:!1,get_json:!0})}};
Form.prototype.load=function(a){null===a||"SUCCESS"!==a.status?this.error(a):(this.setLoadingStatus(this.m_loadingStatus.LOADED),this.clear(),null!==this.m_callbackSuccess&&this.m_callbackSuccess(a))};Form.prototype.error=function(a){a=void 0===a?null:a;this.setLoadingStatus(this.m_loadingStatus.FAILED);this.clear();null!==this.m_callbackError&&this.m_callbackError(a)};Form.prototype.abort=function(){null!==this.m_currentXHR&&this.m_currentXHR.abort();this.setLoadingStatus(this.m_loadingStatus.NONE)};
