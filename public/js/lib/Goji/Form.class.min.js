...
Form.prototype.submit=function(a){var b=this;a=void 0===a?null:a;null!==a&&a.preventDefault();if(!this.m_loadingInProgress){this.setLoadingStatus(this.m_loadingStatus.LOADING);null!==this.m_progressBar&&this.m_progressBar.classList.add("shown");a=this.m_parent.action;var d=new FormData(this.m_parent);this.m_currentXHR=SimpleRequest.post(a,d,function(a,c){b.load(a,c)},function(a){b.error()},function(a){b.abort()},function(a,c){b.progress(a,c)},{encode_uri:!1,get_json:!0})}};
Form.prototype.load=function(a,b){null===a||200!==b?this.error(a):(this.setLoadingStatus(this.m_loadingStatus.LOADED),this.clear(),null!==this.m_callbackSuccess&&this.m_callbackSuccess(a))};Form.prototype.error=function(a){a=void 0===a?null:a;this.setLoadingStatus(this.m_loadingStatus.FAILED);this.clear();null!==this.m_callbackError&&this.m_callbackError(a)};Form.prototype.abort=function(){null!==this.m_currentXHR&&this.m_currentXHR.abort();this.setLoadingStatus(this.m_loadingStatus.NONE)};
