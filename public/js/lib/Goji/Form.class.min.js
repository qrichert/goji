...
Form.prototype.submit=function(a){var b=this;a=void 0===a?null:a;null!==a&&a.preventDefault();if(!this.m_loadingInProgress){this.setLoadingStatus(this.m_loadingStatus.LOADING);null!==this.m_progressBar&&this.m_progressBar.classList.add("shown");a=this.m_parent.action;var d=new FormData(this.m_parent);this.m_currentXHR=SimpleRequest.post(a,d,function(a){b.load(a)},function(a){b.error()},function(a){b.abort()},function(a,c){b.progress(a,c)},{encode_uri:!1,get_json:!0})}};
