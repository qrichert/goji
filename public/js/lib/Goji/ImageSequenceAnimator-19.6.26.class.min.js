...
ImageSequenceAnimator.prototype.setProgress=function(a){this.m_ready&&(0>a?a=0:1<a&&(a=1),this.setCurrentIndex(this.m_nbImages*a))};ImageSequenceAnimator.prototype.setCurrentIndex=function(a){this.m_ready&&(a>this.m_nbImages-1&&(a=this.m_nbImages-1),this.m_currentImageIndex=a=Math.floor(a),a=Math.trunc(this.m_currentImageIndex/this.m_nbImagesPerRow),this.setCurrentGridIndex(this.m_currentImageIndex-a*this.m_nbImagesPerRow,a))};
