...
function(){c.imageSequenceLoaded()},!1);window.addEventListener("load",function(){c.imageSequenceLoaded()},!1)};ImageSequenceAnimator.prototype.imageSequenceLoaded=function(){this.m_imageAlreadyLoaded||(this.m_imageAlreadyLoaded=!0,this.m_imageSequenceNaturalWidth=this.m_imageSequence.naturalWidth,this.m_imageSequenceNaturalHeight=this.m_imageSequence.naturalHeight,this.init())};
