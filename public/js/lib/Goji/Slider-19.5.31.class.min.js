...
"navigation_blocks_minimum_width","100px");this.m_jumpToFirstAndLastImage=this.coalesce(c,"jump_to_first_and_last_image",!1);this.m_images=[];this.m_links=[];this.populateImages()};Slider.prototype.coalesce=function(b,a,c){return"undefined"!=typeof b&&null!==b&&b.hasOwnProperty(a)?b[a]:c};Slider.prototype.getNbImages=function(){return this.m_nbImages};Slider.prototype.getCurrentIndex=function(){return this.m_currentIndex};
...
Slider.prototype.addListeners=function(){var b=this;this.m_parent.addEventListener("mouseenter",function(){b.focus()},!1);var a=function(a){a.preventDefault();b.previousImage()},c=function(a){a.preventDefault();b.nextImage()};this.m_navigationPrevious.addEventListener("click",a,!1);this.m_navigationNext.addEventListener("click",c,!1);document.addEventListener("keyup",function(e){console.log(e.target);if(e.target===b.m_parent)switch(e.key){case "ArrowLeft":a(e);break;case "ArrowRight":c(e)}},!1);window.addEventListener("load",
